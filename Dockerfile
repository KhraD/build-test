...
RUN mkdir -p /opt/godot/base \
    ...
    && mkdir -p /opt/godot/gradle/build \
    ...
    && cp ./templates/android_source.zip /opt/godot/gradle/build \
    && cd /opt/godot/gradle \
...
RUN yes | sdkmanager --licenses \
    && sdkmanager "platform-tools" "build-tools;34.0.0" "platforms;android-34" "cmdline-tools;latest" "cmake;3.31.6" "ndk;27.2.12479018" --sdk_root=$ANDROID_SDK_ROOT \
